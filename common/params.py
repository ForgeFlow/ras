...
class TxType(Enum):
  ...
  DEFINED_ON_ACK_FROM_ODOO = auto()
  DEFINED_ON_ACK_FROM_DEVICE = auto()
...
factory_settings = [ #[TxType.FACTORY_SETTINGS]
  "firmwareAtShipment",
  "productName"       ,
  "productionDate"    ,
  "productionLocation",
...
defined_on_ack_from_odoo = [ #[TxType.DEFINED_ON_ACK_FROM_ODOO]
  "id",
  "RASxxx",
...
defined_on_ack_from_device = [ #[TxType.DEFINED_ON_ACK_FROM_DEVICE]
...
keys_routine_calls = [  #[TxType.UPDATED_FROM_ODOO_ON_ROUTINE_CALLS]
  "ssh"                             ,
  "showEmployeeName"                ,
  "sshPassword"                     ,
  "language"                        ,
